...
public class FlyC: MonoBehaviour{
	...
	void OnCollisionEnter(Collision col){
		...
		//Vector3 velo=smoke.particleEmitter.worldVelocity;
		//velo.y=6;
		smoke.Translate (0,2,0);
		//smoke.particleEmitter.worldVelocity=velo;
		//smoke.particleEmitter.minSize=1;
		//smoke.particleEmitter.maxSize=10;
